function convertRomanNumerals() {
    ...
    let validation = convertInputValidation(numberInput)

    let result = validation ? validation : romanize(numberInput)
...
function convertInputValidation(
    numberInput /*number*/,
) /* return: string, false */ {
